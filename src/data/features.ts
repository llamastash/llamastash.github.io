...
export const features: Feature[] = [
  ...
  },
  {
    ...
    body: "The TUI, CLI, and daemon are the same binary. The daemon auto-spawns when needed, running models survive UI exit, and the same launch primitives show up in both human and agent workflows.",
    accent: "blue",
  },
  {
  ...
  },
  {
    ...
    body: "Stable `--json` output, documented exit codes, `pull` and `recommend` subcommands, plus an installable AgentSkills bundle for Claude Code, OpenClaw, OpenCode, and other harnesses.",
    accent: "teal",
  },
];
